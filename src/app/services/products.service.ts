...
export class ProductsService {
  ...
  getProducts() {
...

    {
      ...
      description: '40+20+8MP Leica quad rear camera',
...

    {
      ...
      description: 'Triple-camera system with 12MP',
...

    {
      ...
      description: '48MP + 8MP + 13MP primary camera',
...

    {
      ...
      description: '12MP camera with OIS and 7MP',
...

    {
      ...
      description: '13MP+5MP ultra-wide dual camera ',
...

    {
      ...
      description: 'Ultra-wide dual camera  16MP Autofocus ',
      imgAlt: 'CAT Phone',
      price: 850,
      isAvailable: true,
